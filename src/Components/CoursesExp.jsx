      ...
      <div className="bg-gray-100 min-h-screen flex items-center justify-center">
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="text-center my-8">
            ...
            <h1 className="text-4xl font-semibold text-orange-600 mt-2 animate__animated animate__fadeInLeft animate__delay-1s">Expert-level</h1>
          </div>
            ...
            {courses.map((course) => (
              <div key={course._id} className="text-white p-6 rounded-lg shadow-lg animate__animated animate__fadeIn" style={{ backgroundColor: '#FF751A' }}>
                ...
                <div className="mt-4 space-y-2">
                  <h3 className="text-xl font-bold">{course.expcTitle}</h3>
                  ...
                  <p className="text-sm">
                    Instructor: <span className="font-semibold">{course.expcinstructor}</span>
                  </p>
                  <div className="mt-4">
                    <Link className="bg-white text-orange-600 px-4 py-2 rounded shadow" to={`/courses/exp/${course._id}`}>
                      Read more
                    </Link>
                  </div>
                </div>
